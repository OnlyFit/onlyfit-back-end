...
import static ieti.project.onlyfit.utils.Constants.*;
            ...
            try
            {
                ...
                if ( token != null )
                {
                    ...
                    if (roles == null) {
                        ...
                        SecurityContextHolder.getContext().setAuthentication( new ieti.project.onlyfit.config.TokenAuthentication( token, subject, roles));
                    }
